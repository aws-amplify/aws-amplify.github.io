...
### UI Colors
<span class="excerpt">UI Color for AWS amplify are derived from a primary and secondary color palette. Most primary actions are wrapped in Orange. Dark backgrounds and darker treatments will typically receive the Squid Ink color treatment.</span>
